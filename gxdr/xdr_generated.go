...
func (u *HcnetMessage) GeneralizedTxSet() *GeneralizedTransactionSet {
	...
	default:
		XdrPanic("HcnetMessage.GeneralizedTxSet accessed when Type == %v", u.Type)
		return nil
	}
}
...
func (u *HcnetMessage) FloodAdvert() *FloodAdvert {
	...
	default:
		XdrPanic("HcnetMessage.FloodAdvert accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *HcnetMessage) FloodDemand() *FloodDemand {
	...
	default:
		XdrPanic("HcnetMessage.FloodDemand accessed when Type == %v", u.Type)
		return nil
	}
}
